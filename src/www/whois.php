...
$domain = array_key_exists ("domain", $_REQUEST)? strtolower(trim($_REQUEST["domain"])) : "";
$domainValue = htmlspecialchars($domain);

titelHilfe ("Whois-Abfrage", <<<LIMIT1
...
<form method="post" class="form-horizontal">
  <div class="row" style="margin-bottom:20px">
    <div class="input-group">
      ...
      <input class="form-control" type="text" id="idomain" name="domain" value="$domainValue">
      <span class="input-group-btn">
...
else if (array_key_exists ("domain", $_REQUEST))
{
