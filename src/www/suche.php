...
$suchValue = array_key_exists ( "search", $_REQUEST ) ? htmlspecialchars ( $_REQUEST[ "search" ] ) : "";

titleAndHelp ( "Freitextsuche", <<<LIMIT1
...
<form method="post" class="form-horizontal">
  <div class="row" style="margin-bottom:20px">
    <div class="input-group">
      ...
      <input class="form-control" type="search" id="isuche" name="search" value="$suchValue">
      <span class="input-group-btn">
...
if ( array_key_exists ( "search", $_REQUEST ) )
{
  if ( array_key_exists ( "regSwitch", $_REQUEST ) && $_REQUEST[ "regSwitch" ] != "on" )
  {
    $nadel = preg_quote ( $_REQUEST[ "search" ] );
  }
  else
  {
    $nadel = $_REQUEST[ "search" ];
  }
...
LIMIT1;
      ...
      do
      {
        ...
        list ($res, $weitere, $pos) = suchMarkierung ( $ort, $fund[ "inhalt" ], $_REQUEST[ "search" ], array_key_exists ( "regSwitch", $_REQUEST ) && $_REQUEST[ "regSwitch" ] == "on", array_key_exists ( "caseSwitch", $_REQUEST ) && $_REQUEST[ "caseSwitch" ] == "on", 0 );
...
LIMIT1;
  ...
  <div class="row">  
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
LIMIT1;
    echo "<p><strong>", htmlspecialchars ( $_REQUEST[ "search" ] ), "</strong> wurde nicht gefunden.</p>";
    echo <<<LIMIT1
      </div>
    </div>
  </div>
