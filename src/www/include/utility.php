...
{
  return preg_replace_callback ("/[^[:print:]|^[:space:]]/".($unicode?"u":""), function ($m) { global $nonPrint; return $nonPrint; }, $string );
}
...
function zeigeInhalt ($nr, $inhalt, $eigenschaften, $mime="")
{
  ...
  $inhaltNormal = preg_replace_callback ("/[^[:print:]|^[:space:]]/u", function ($m) { global $nonPrint; return $nonPrint; },  htmlspecialchars ($inhalt) );
...
// Titel anzeigen und Hilfe anbieten

function titelHilfe ($titel, $hilfe)
{
  echo <<<LIMIT1
  <div class="row">
    <h2>
...
LIMIT1;
  ...
  {
    echo <<<LIMIT1
      <a href="#hilfeModal" data-toggle="modal"><small><span class="text-success"><i class="fa fa-question-circle"></i></span></small></a>
LIMIT1;
  }
    ...
    <div class="modal-content">
      <div class="modal-header">
        <div class="alert alert-success" role="alert">
          ...
          <div class="msgText"><strong>$titel</strong></div>
        </div>
      </div>
